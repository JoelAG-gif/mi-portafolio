# 🚀 Portafolio Profesional - Jireh Aroni



> **Desarrollador Frontend | Analista de Datos | Especialista en Angular & Power BI**
...
Bienvenido a mi portafolio web profesional. Esta aplicación ha sido desarrollada con **Angular 19** y sirve como punto central para exhibir mis habilidades técnicas, certificaciones y proyectos destacados.



La interfaz fusiona un diseño minimalista con efectos visuales **RGB neón y estética Cyberpunk**, ofreciendo una experiencia de usuario fluida, reactiva y totalmente adaptada a dispositivos móviles.
...
* **Diseño Moderno:** Interfaz limpia con efectos visuales RGB neón y bordes animados.

* **Modo Oscuro/Claro:** Sistema de temas con transiciones suaves y persistencia de preferencias.

* **Efectos Premium:** Gradientes cónicos giratorios, cursores parpadeantes y sombras dinámicas.

* **Animaciones:** Efecto de escritura automática (*typewriter*) y transiciones fluidas entre secciones.
...
* **Navbar Tipo Isla:** Menú flotante con efectos de transparencia y hover avanzados.

* **Interacción:** Validaciones de formularios en tiempo real y feedback visual de estado.
...
| **Herramientas** | Git/GitHub, VS Code, Angular CLI, Vercel |
...
El proyecto está organizado en secciones modulares para facilitar la navegación:



1.  **🏠 Inicio:** Presentación con alternancia de roles y efectos de escritura.

2.  **💼 Proyectos:** Galería interactiva con filtros y detalles técnicos.

3.  **🎯 Habilidades:** Visualización de stack técnico mediante iconos y pills.

4.  **📜 Certificados:** Visor de credenciales con opción de modal PDF.

5.  **📧 Contacto:** Formulario funcional con validaciones.
...
*Desarrollador apasionado por crear experiencias digitales únicas y transformar datos en decisiones.*



* 💼 **LinkedIn:** [@jireharoni](https://linkedin.com/in/jireharoni)

* 📧 **Email:** [jireharoni03@gmail.com](mailto:jireharoni03@gmail.com)
